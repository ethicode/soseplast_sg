...
class ArticleController
{
    ...
    public function searchArticles()
    {
        ...
        $articles = $this->articleModel->searchArticles($search, $calc_page, $num_results_on_page);
        $categories = $this->modelCategory->getAllCategory();
        require_once('views/article/articles.php');
    }
    ...
    public function saveArticle()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $this->articleModel->saveArticle($name, $description, $category_id, $quantity, $location, $image_url, $image_1, $image_2, $image_3, $article_id);
        }
        header('Location: index.php?action=articles');
    }
