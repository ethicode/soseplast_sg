            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="index.php?action=login" method="POST">
                        <h3 class="text-center m-b-20 fw-bold">Connexion</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" name="email" type="text" required="" placeholder="Email ou matricule">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <button class="btn w-100 btn-lg btn-danger btn-rounded text-white" name="submit" type="submit">Se connecter</button>
                            </div>
                        </div>
                        <div class="row">
