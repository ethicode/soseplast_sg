            ...
            <div class="row">
                <div class="col-lg-4 offset-md-4">
                    <div class="container card">
                        <div class="card-body">
                            <form class="form-horizontal form-material" id="loginform" action="index.php?action=register" method="POST">
                                <h2 class="text-center m-b-20">Créer un compte</h2>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email ou matricule</label>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon2"><i class="ti-email"></i></span>
                                        <input name="email" type="text" class="form-control" placeholder="" aria-label="Email" aria-describedby="basic-addon2">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="password" type="text" class="form-control" placeholder="" aria-label="Password" aria-describedby="basic-addon3">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="password2" type="text" class="form-control" placeholder="" aria-label="Password" aria-describedby="basic-addon4">
                                    </div>
                                </div>
                                <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button class="btn w-100 btn-lg btn-danger btn-rounded text-white" name="submit" type="submit">S'inscrire</button>
                                    </div>
                                </div>
                                <div class="row">
