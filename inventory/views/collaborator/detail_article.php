                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card el-element-overlay">
                            <div class="el-card-item p-0">
                                <div class="el-card-avatar el-overlay-1 m-0"> <img src="<?php echo $article != null ? $article["image_url"] : "./public/assets/images/no_image.jpg" ?>" alt="user" />
                                    <div class="el-overlay m-0">
                                        <ul class="el-info">
                                            <li><a class="btn default btn-outline image-popup-vertical-fit" href="<?php echo $article != null ? $article["image_url"] : "./public/assets/images/no_image.jpg" ?>"><i class="icon-magnifier"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="card el-element-overlay m-0">
                                        <div class="el-card-item p-0 shadow-sm">
                                ...
                                <div class="card b-all shadow-none">
                                    ...
                                    <div class="card-body">
                                        <?php if (isset($_SESSION["soseplast_user_id"])): ?>
                                            <?php if ($command): ?>
                                                <button type="button" class="btn waves-effect waves-light btn-danger btn-lg" onclick="confirmCancelReservation('<?php echo $article["id"]; ?>')">Annuler la réservation</button>
                                            <?php else: ?>
                                            <button type="button" class="btn waves-effect waves-light btn-dark btn-lg" data-bs-toggle="modal" data-bs-target="#command">Commander</button>
                                            <?php endif ?>
                                            <?php else: ?>
                                            <a href="index.php?action=loginForm" class="btn waves-effect waves-light btn-danger btn-lg">Connectez-vous pour commander cet article</a>
                                        <?php endif ?>
