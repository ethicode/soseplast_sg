                                    ...
                                    <div class="col">
                                        <div class="d-flex">
                                            <div class="align-self-center">
                                                <h4 class="card-title m-t-10">Liste des commandes</h4>
                                            </div>
                                            <!-- <div class="ms-auto">
                                    ...
                                    <table  id="myTable"
                                        ...
                                        <tbody>
                                            <?php foreach ($commandes as $commande): ?>
                                                <tr>
                                                    <td>
                                                        <a href="?action=detailArticleAdmin&id=<?php echo $commande["id_article"]; ?>"><?php echo $commande["name"]; ?></a>
                                                    </td>
                                                    <?php if ($commande["is_validated"] === 1): ?>
                                                        <td><span class="label label-success">Validé</span> </td>
                                                    <?php elseif ($commande["is_validated"] === 0): ?>
                                                        <td><span class="label label-danger">Non validé</span> </td>
                                                    <?php else: ?>
                                                        <td><span class="label label-info">En attente</span> </td>
                                                    <?php endif ?>
                                                    <td><a href=""><span class="label label-primary"><?php echo $commande["username"]; ?></span> </a></td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <?php if ($commande["is_validated"] == 0): ?>
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#<?php echo 'miseEnVenteModal' . $commande["id"] ?>">Valider</a>
                                                                    <a class="dropdown-item" href="index.php?action=updatecommande&id=<?php echo $commande["id"] ?>">Rejeter</a>
                                                                <?php elseif ($commande["is_validated"] == 1): ?>
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#<?php echo 'annulerVenteModal' . $commande["id"] ?>">Annuler la validation</a>
                                                                <?php endif ?>
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="confirmDelete('<?php echo $commande["id"]; ?>')">Supprimer</a>
                                                                <!-- <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="javascript:void(0)">Separated link</a> -->
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <div class="modal" id="<?php echo 'miseEnVenteModal' . $commande["id"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                                        <form method="POST" action="index.php?action=updateValidationCommand">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" disabled value="<?php echo $commande["name"]; ?>" class="form-control text-dark" id="recipient-name1">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" value="<?php echo $commande["quantity"]; ?>" name="quantity" class="form-control text-dark">
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="modal" id="<?php echo 'annulerVenteModal' . $commande["id"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                                        <form method="POST" action="index.php?action=updateValidationCommand">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <!-- <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php endif ?>
                                                                            <input type="hidden" value="<?php echo $commande["quantity"]; ?>" name="quantity" class="form-control text-dark">
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-default" data-bs-dismiss="modal">Fermer</button>
                                                                        <button type="submit" class="btn btn-danger text-white">Annuler la validation</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
