                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex">
                                            ...
                                            <h4 class="card-title m-t-10">Mes commandes</h4>
                                            </div>
                                            <!-- <div class="ms-auto">
                                    ...
                                    <table  id="myTable"
                                        ...
                                        <tbody>
                                            <?php foreach ($commandes as $commande): ?>
                                                <tr>
                                                    <td>
                                                        <a href="?action=detailArticle&id=<?php echo $commande["id_article"]; ?>"><?php echo $commande["name"]; ?></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-dark" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Annuler
                                                            </button>
                                                        </div>
                                                    </td>
