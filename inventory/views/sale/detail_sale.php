                                ...
                                <div class="card b-all shadow-none">
                                    ...
                                    <div class="card-body">
                                        <?php if (isset($_SESSION["soseplast_user_id"])): ?>
                                            <button type="button" class="btn waves-effect waves-light btn-danger btn-lg" data-bs-toggle="modal" data-bs-target="#command">Réserver</button>
                                        <?php else: ?>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer text-center">
                                                            <input type="text" value="<?php echo $user["id"] ?>">
                                                            <input type="text" value="<?php echo $article["id"] ?>">
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="./public/assets/images/no_image.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
