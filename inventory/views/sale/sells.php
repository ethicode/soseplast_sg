                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table  id="myTable"
                                            class="table border m-t-30 table-hover"
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <?php if ($article["for_sale"] == 0): ?>
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#<?php echo 'miseEnVenteModal' . $article["id"] ?>">Mettre en vente</a>
                                                                <?php else: ?>
                                ...
                                <!-- <?php if (ceil($total_pages / $num_results_on_page) > 0): ?>
                                    <ul class="pagination">
                                        <?php if ($page > 1): ?>
                                            <li class="prev page-item"><a class="page-link" href="index.php?action=envente&page=<?php echo $page - 1 ?>">Prev</a></li>
                                        <?php endif; ?>

                                        <?php if ($page > 3): ?>
                                            <li class="start page-item"><a class="page-link" href="index.php?action=envente&page=1">1</a></li>
                                            <li class="dots page-item page-link">...</li>
                                        <?php endif; ?>

                                        <?php if ($page - 2 > 0): ?><li class="page <?php if ($page - 2 == $page) echo 'active'; ?>"><a class="page-link" href="index.php?action=envente&page=<?php echo $page - 2 ?>"><?php echo $page - 2 ?></a></li><?php endif; ?>
                                        <?php if ($page - 1 > 0): ?><li class="page <?php if ($page - 1 == $page) echo 'active'; ?>"><a class="page-link" href="index.php?action=envente&page=<?php echo $page - 1 ?>"><?php echo $page - 1 ?></a></li><?php endif; ?>

                                        <li class="currentpage page-item active"><a class="page-link" href="index.php?action=envente&page=<?php echo $page ?>"><?php echo $page ?></a></li>

                                        <?php if ($page + 1 < ceil($total_pages / $num_results_on_page) + 1): ?><li class="page-item page <?php if ($page + 1 == $page) echo 'active'; ?>"><a class="page-link" href="index.php?action=envente&page=<?php echo $page + 1 ?>"><?php echo $page + 1 ?></a></li><?php endif; ?>
                                        <?php if ($page + 2 < ceil($total_pages / $num_results_on_page) + 1): ?><li class="page-item page <?php if ($page + 2 == $page) echo 'active'; ?>"><a class="page-link" href="index.php?action=envente&page=<?php echo $page + 2 ?>"><?php echo $page + 2 ?></a></li><?php endif; ?>

                                        <?php if ($page < ceil($total_pages / $num_results_on_page) - 2): ?>
                                            <li class="dots page-link">...</li>
                                            <li class="end"><a class="page-link" href="index.php?action=envente&page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
                                        <?php endif; ?>

                                        <?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
                                            <li class="next"><a class="page-link" href="index.php?action=envente&page=<?php echo $page + 1 ?>">Next</a></li>
                                        <?php endif; ?>
                                    </ul>
                                <?php endif; ?> -->
                            </div>
