                            ...
                            <form class="form-horizontal form-material" id="loginform" action="index.php?action=register" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="password" type="text" class="form-control" placeholder="Password" aria-label="Password" aria-describedby="basic-addon3">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="password2" type="text" class="form-control" placeholder="Confirm Password" aria-label="Password" aria-describedby="basic-addon4">
                                    </div>
                                </div>
