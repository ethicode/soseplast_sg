            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <li> <a class="waves-effect waves-dark" href="index.php?action=envente"><i class="ti-shopping-cart-full"></i><span class="hide-menu">CESSION</span></a></li>
                       <li> <a class="waves-effect waves-dark" href="index.php?action=dons"><i class="ti-shopping-cart-full"></i><span class="hide-menu">DON</span></a></li>
