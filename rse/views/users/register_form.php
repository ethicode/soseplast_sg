...
<head>
    ...
    <title>SOSEPLAST - CREER UN COMPTE</title>
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(./public/assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="index.php?action=login" method="POST">
                        <h3 class="text-center m-b-20">Créer un compte</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" name="email" type="text" required="" placeholder="Matricule">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="password" type="password" required="" placeholder="Confirmer le mot de passe">
                            </div>
                        </div>
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <button class="btn w-100 btn-lg btn-info btn-rounded text-white" name="submit" type="submit">Créer un compte</button>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Vous avez déja un compte? <a href="index.php?action=loginForm" class="text-info m-l-5"><b>Connectez vous</b></a>
                            </div>
                        </div>
                    </form>
