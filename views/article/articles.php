                                                ...
                                                <?php foreach ($articles as $article): ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($article["for_sale"] == 1): ?>
                                                            <td><span class="label label-info">En vente</span> </td>
                                                        <?php else: ?>
                                                            <td> </td>
                                                        <?php endif ?>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#<?php echo 'annulerVenteModal' . $article["id"] ?>">Annuler la vente</a>
                                                                    <?php endif ?>
