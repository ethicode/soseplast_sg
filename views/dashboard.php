            ...
            <div class="container-fluid">
                ...
                <div class="row widget-app-columns">
                    <div class="col-xl-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Demandes récents</h4>
                                        ...
                                        <?php foreach ($requests as $request): ?>
                                            ...
                                            <span class="profile-status online pull-right"></span>
                                                ...
                                                <div class="mail-contnet">
                                                    ...
                                                    <span class="mail-desc"><?php echo $request["title"] ?></span>
                                                    <span class="time"><?php echo $request["created_at"] ?></span>
                                                </div>
                                            </a>
                                        <?php endforeach ?>
                                    </div>
                                    ...
                                    <table id="demo-foo-addrow" class="table m-t-30 table-hover no-wrap contact-list"
                                        ...
                                        <tbody>
                                            <?php foreach ($commands as $command): ?>
                                                <tr>
                                                    <td>
                                                        <a href="javascript:void(0)"> <?= $command['name'] ?></a>
                                                    </td>
