                            ...
                            <div class="contact-page-aside">
                                ...
                                <div class="left-aside bg-light-part">
                                    <ul class="list-style-none">
                                        ...
                                        <li><a href="javascript:void(0)"><?php echo $categories["name"]?> <span><?php echo $categories["products_count"]?></span></a></li>
                                        <?php endforeach?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0)"><img
                                                                src="./public/assets/images/users/4.jpg" alt="user" width="40"
                                                                class="img-circle" /> <?php echo $product["name"];?></a>
                                                    </td>
