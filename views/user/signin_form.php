...
<head>
    ...
    <!-- page css -->
    <link href="../pages/dist/css/pages/login-register-lock.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="../pages/dist/css/style.min.css" rel="stylesheet">
                ...
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="login.php" method="POST">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" name="matricule" type="text" required="" placeholder="Matricule">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <button class="btn w-100 btn-lg btn-info btn-rounded text-white" name="submit" type="submit">Se connecter</button>
                            </div>
                        </div>
                        <div class="row">
